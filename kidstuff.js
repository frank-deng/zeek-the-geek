levelData = [
	...
	new Stage(function(stage){
		...
		stage.setObject(3, 5, new Treasure());
		...
		stage.setObject(8, 7, new Wall(10));
		stage.setObject(9, 7, new Wall(10));
		...
		stage.setObject(1, 8, new Wall(2));
		stage.setObject(2, 8, new Wall(2));
		stage.setObject(3, 8, new Wall(2));
		stage.setObject(4, 8, new Wall(2));
		stage.setObject(5, 8, new Flower(false));
		stage.setObject(7, 8, new Wall(10));
		stage.setObject(8, 8, new Wall(10));
		stage.setObject(9, 8, new Wall(10));
	...
	new Stage(function(stage){
		...
		stage.setObject(11, 6, new Treasure());
		...
		stage.setObject(15, 9, new Wall(5));
	...
	new Stage(function(stage){
		...
		stage.demon.push(new Demon(stage, 11, 6, DIR_SOUTH));
		...
		stage.setObject(2, 7, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.player.push(new Player(stage, 2, 7));
	...
	new Stage(function(stage){
		...
		stage.setObject(3, 1, new Treasure());
		stage.setObject(4, 1, new Flower(false));
		stage.setObject(5, 1, new Wall(4));
		stage.setObject(7, 1, new Flower(false));
		stage.setObject(9, 1, new Flower(false));
		stage.setObject(11, 1, new Ball());
		stage.player.push(new Player(stage, 12, 1));
		...
		stage.setObject(14, 6, new Wall(10));
	...
	new Stage(function(stage){
		...
		stage.setObject(1, 3, new Mushroom(true));
		stage.setObject(2, 3, new Mushroom(true));
		...
		stage.demon.push(new Demon(stage, 15, 8, DIR_NORTH));
		...
		stage.setObject(4, 9, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.setObject(5, 9, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.setObject(1, 3, new Wall(3));
		...
		stage.setObject(15, 10, new Ball());
	...
	new Stage(function(stage){
		...
		//Row 2
		stage.setObject(0, 2, new Wall(5));
		stage.setObject(1, 2, new Wall(10));
		...
		stage.setObject(14, 2, new PFlower(false));
		stage.setObject(15, 2, new Treasure());
		stage.setObject(16, 2, new Wall(5));
		...
		stage.setObject(7, 5, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.setObject(10, 10, new Wall(0));
		stage.setObject(11, 10, new Treasure());
		stage.setObject(13, 10, new Flower(false));
		stage.setObject(15, 10, new Mushroom(false));
		stage.setObject(16, 10, new Wall(0));
	...
	new Stage(function(stage){
		...
		stage.setObject(13, 2, new Wall(4));
		stage.setObject(14, 2, new Wall(4));
	...
	new Stage(function(stage){
		...
		stage.setObject(14, 5, new Wall(10));
		stage.setObject(15, 5, new Flower(false));
		...
		stage.setObject(12, 7, new Wall(10));
	...
	new Stage(function(stage){
		...
		stage.setObject(1, 4, new Treasure());
		stage.setObject(3, 4, new Flower(false));
		stage.setObject(7, 4, new AppleRotten());
		stage.setObject(10, 4, new Flower(false));
		...
		stage.setObject(9, 7, new Flower(false));
		stage.setObject(11, 7, new Door());
		stage.setObject(12, 7, new AppleRotten());
	...
	new Stage(function(stage){
		...
		stage.setObject(0, 1, new Wall(1));
		stage.player.push(new Player(stage, 1, 1));
		stage.setObject(2, 1, new Wall(1));
		stage.setObject(3, 1, new Wall(1));
		...
		stage.setObject(12, 4, new Mushroom(false));
		stage.setObject(13, 4, new Flower(false));
		stage.setObject(14, 4, new Flower(false));
		stage.setObject(15, 4, new Treasure());
		stage.setObject(16, 4, new Wall(1));
		...
		stage.setObject(3, 10, new Flower(false));
		stage.setObject(4, 10, new PFlower(true));
		stage.setObject(5, 10, new Wall(1));
		stage.setObject(6, 10, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.setObject(12, 1, new AppleRotten());
		stage.setObject(13, 1, new Flower(true));
		...
		stage.setObject(7, 3, new Flower(false));
		stage.setObject(8, 3, new Flower(false));
		stage.player.push(new Player(stage, 9, 3));
		...
		stage.setObject(10, 4, new PFlower(true));
		stage.setObject(11, 4, new Flower(false));
		stage.setObject(12, 4, new Wall(9));
		stage.setObject(13, 4, new Flower(false));
		stage.setObject(14, 4, new Flower(false));
		stage.setObject(15, 4, new Flower(false));
		stage.setObject(16, 4, new Wall(9));
		...
		stage.setObject(13, 5, new Flower(false));
		stage.setObject(14, 5, new Treasure());
		stage.setObject(15, 5, new PFlower(true));
		stage.setObject(16, 5, new Wall(9));
		...
		stage.setObject(6, 8, new Wall(9));
		stage.setObject(7, 8, new Flower(false));
		...
		stage.setObject(1, 9, new Flower(false));
		stage.setObject(2, 9, new Flower(false));
		stage.setObject(3, 9, new Mushroom(false));
		stage.setObject(4, 9, new Flower(false));
	...
	new Stage(function(stage){
		...
		stage.player.push(new Player(stage, 12, 2));
		...
		stage.setObject(0, 5, new Wall(6));
		stage.setObject(2, 5, new Flower(false));
		stage.setObject(4, 5, new AppleRotten());
		stage.setObject(6, 5, new AppleRotten());
		...
		stage.setObject(3, 10, new Flower(false));
		stage.setObject(4, 10, new PFlower(true));
		stage.setObject(6, 10, new Apple());
		stage.setObject(7, 10, new Flower(false));
		stage.setObject(9, 10, new Flower(false));
		stage.setObject(10, 10, new Wall(6));
		stage.setObject(11, 10, new Key());
	...
	new Stage(function(stage){
		...
		stage.setObject(5, 2, new AppleRotten());
		...
		//Row 5
		stage.setObject(0, 5, new Wall(7));
		stage.setObject(1, 5, new Wall(7));
	...
	new Stage(function(stage){
		...
		stage.setObject(2, 3, new PFlower(false));
		...
		stage.setObject(4, 4, new Apple());
		stage.setObject(5, 4, new LaserGun());
		stage.setObject(6, 4, new Wall(4));
		stage.setObject(7, 4, new Mushroom(false));
		stage.setObject(9, 4, new Flower(false));
		stage.setObject(10, 4, new Flower(false));
		stage.setObject(11, 4, new Flower(false));
		...
		stage.setObject(10, 6, new Flower(false));
		stage.setObject(11, 6, new Wall(4));
		stage.demon.push(new Demon(stage, 12, 6, DIR_SOUTH));
		stage.setObject(13, 6, new Wall(4));
		stage.setObject(15, 6, new Flower(true));
		stage.setObject(16, 6, new Wall(4));
		...
		stage.setObject(3, 9, new PFlower(true));
		stage.demon.push(new Demon(stage, 5, 9, DIR_WEST));
	...
	new Stage(function(stage){
		...
		//Row 2
		stage.setObject(0, 2, new Wall(0));
		stage.setObject(1, 2, new LaserGun());
		stage.setObject(2, 2, new Flower(false));
		stage.setObject(5, 2, new Flower(false));
		...
		stage.setObject(3, 8, new Wall(0));
		stage.setObject(4, 8, new Flower(false));
		stage.player.push(new Player(stage, 5, 8));
		...
		stage.setObject(13, 10, new Wall(0));
		stage.setObject(14, 10, new PFlower(true));
	...
	new Stage(function(stage){
		...
		stage.setObject(12, 6, new Mushroom(false));
		...
		stage.setObject(7, 10, new Flower(true));
		stage.setObject(8, 10, new Flower(false));
		stage.setObject(11, 10, new Wall(8));
		stage.setObject(13, 10, new Flower(false));
		stage.setObject(15, 10, new Flower(false));
		stage.setObject(16, 10, new Wall(8));
	...
	new Stage(function(stage){
		...
		stage.setObject(11, 4, new Wall(1));
		stage.setObject(12, 4, new Flower(false));
		stage.setObject(14, 4, new Wall(2));
		...
		stage.setObject(3, 5, new Flower(false));
		stage.setObject(5, 5, new Door());
		stage.setObject(7, 5, new AppleRotten());
		...
		stage.setObject(3, 6, new Flower(false));
		stage.setObject(5, 6, new Wall(1));
		stage.setObject(7, 6, new AppleRotten());
		stage.setObject(8, 6, new AppleRotten());
		stage.setObject(9, 6, new AppleRotten());
		stage.setObject(11, 6, new Wall(1));
		stage.setObject(13, 6, new Flower(false));
		stage.setObject(16, 6, new Wall(2));
		...
		stage.setObject(11, 9, new Flower(false));
		stage.setObject(14, 9, new PFlower(true));
		stage.setObject(15, 9, new Wall(2));
		stage.setObject(16, 9, new Wall(2));
	...
	new Stage(function(stage){
		...
		stage.setObject(8, 2, new Flower(false));
		stage.setObject(9, 2, new Wall(10));
		stage.setObject(10, 2, new Flower(false));
		...
		stage.setObject(10, 4, new Flower(false));
		stage.setObject(11, 4, new Wall(5));
		stage.demon.push(new Demon(stage, 12, 4, DIR_SOUTH));
		stage.setObject(13, 4, new Wall(5));
		...
		stage.setObject(3, 9, new Crystal());
		stage.setObject(5, 9, new Flower(false));
		stage.setObject(6, 9, new Wall(10));
		stage.setObject(7, 9, new Wall(10));
	...
	new Stage(function(stage){
		...
		stage.demon.push(new Demon(stage, 10, 3, DIR_WEST));
		stage.setObject(11, 3, new Wall(1));
		stage.setObject(12, 3, new Wall(1));
		stage.setObject(13, 3, new Wall(1));
		stage.setObject(14, 3, new Wall(1));
		...
		stage.setObject(10, 4, new Wall(1));
		stage.setObject(11, 4, new Wall(1));
		stage.setObject(12, 4, new Wall(1));
		stage.setObject(16, 4, new Wall(1));
		...
		stage.setObject(3, 6, new LaserGun());
		...
		stage.setObject(3, 7, new Wall(1));
		stage.setObject(4, 7, new Wall(1));
		stage.setObject(5, 7, new LaserGun());
		stage.setObject(6, 7, new Wall(1));
		stage.setObject(8, 7, new Wall(1));
		stage.setObject(9, 7, new Flower(false));
		...
		stage.setObject(0, 9, new Wall(1));
		stage.setObject(2, 9, new Flower(false));
		stage.setObject(10, 9, new Treasure());
		stage.setObject(11, 9, new Flower(false));
		stage.setObject(12, 9, new Flower(false));
	...
	new Stage(function(stage){
		...
		stage.setObject(0, 2, new Wall(9));
		stage.setObject(1, 2, new LaserGun());
		stage.setObject(2, 2, new AppleRotten());
		stage.setObject(3, 2, new PFlower(false));
		stage.setObject(5, 2, new PFlower(false));
		...
		//Row 7
		stage.setObject(0, 7, new Wall(9));
		stage.setObject(1, 7, new AppleRotten());
		stage.setObject(3, 7, new Flower(false));
		stage.setObject(5, 7, new Flower(false));
		stage.setObject(7, 7, new Flower(false));
		stage.setObject(8, 7, new Flower(false));
		...
		//Row 8
		stage.setObject(0, 8, new Wall(9));
		stage.setObject(1, 8, new PFlower(false));
		...
		stage.setObject(6, 9, new Flower(false));
		stage.setObject(8, 9, new Crystal());
		stage.setObject(10, 9, new Wall(10));
		stage.setObject(11, 9, new Wall(9));
		stage.setObject(12, 9, new Flower(false));
		...
		stage.setObject(6, 10, new Flower(false));
		stage.setObject(7, 10, new Wall(10));
		stage.setObject(8, 10, new Treasure());
		stage.setObject(9, 10, new Crystal());
		stage.demon.push(new Demon(stage, 10, 10, DIR_EAST));
	...
	new Stage(function(stage){
		...
		//Row 7
		stage.setObject(0, 7, new Wall(4));
		stage.setObject(1, 7, new Mushroom(false));
		stage.setObject(4, 7, new Flower(true));
	...
	new Stage(function(stage){
		...
		stage.setObject(7, 2, new Flower(false));
		stage.setObject(9, 2, new Mushroom(false));
		stage.setObject(10, 2, new Wall(6));
		stage.setObject(12, 2, new Flower(false));
		stage.setObject(14, 2, new Flower(false));
		stage.player.push(new Player(stage, 15, 2));
		stage.setObject(16, 2, new Wall(6));
		...
		stage.setObject(0, 4, new Wall(6));
		stage.setObject(1, 4, new Treasure());
		stage.setObject(2, 4, new Treasure());
		stage.setObject(3, 4, new Flower(true));
		stage.setObject(5, 4, new Flower(false));
		...
		stage.demon.push(new Demon(stage, 9, 6, DIR_WEST));
		...
		stage.setObject(4, 8, new Wall(6));
		stage.setObject(5, 8, new LaserGun());
		stage.setObject(6, 8, new Wall(6));
		stage.setObject(7, 8, new LaserGun());
	...
	new Stage(function(stage){
		//Row 0
		stage.setObject(0, 0, new Wall(10));
		stage.setObject(1, 0, new Wall(10));
		stage.setObject(2, 0, new Wall(10));
		stage.setObject(3, 0, new Wall(10));
		stage.setObject(4, 0, new Wall(10));
		stage.setObject(5, 0, new Wall(10));
		stage.setObject(6, 0, new Wall(10));
		stage.setObject(7, 0, new Wall(10));
		stage.setObject(8, 0, new Wall(10));
		stage.setObject(9, 0, new Wall(10));
		stage.setObject(10, 0, new Wall(10));
		stage.setObject(11, 0, new Wall(10));
		stage.setObject(12, 0, new Wall(10));
		stage.setObject(13, 0, new Wall(10));
		stage.setObject(14, 0, new Wall(10));
		stage.setObject(15, 0, new Wall(10));
		stage.setObject(16, 0, new Wall(10));

		//Row 1
		stage.setObject(0, 1, new Wall(10));
		stage.player.push(new Player(stage, 1, 1));
		stage.setObject(2, 1, new Ball());
		stage.setObject(5, 1, new Wall(10));
		stage.setObject(6, 1, new Flower(false));
		stage.setObject(9, 1, new Flower(false));
		stage.setObject(13, 1, new Flower(false));
		...
		//Row 2
		stage.setObject(0, 2, new Wall(10));
		stage.setObject(1, 2, new Wall(10));
		stage.setObject(2, 2, new Wall(10));
		...
		//Row 3
		stage.setObject(0, 3, new Wall(10));
		stage.setObject(1, 3, new AppleRotten());
		stage.setObject(2, 3, new PFlower(false));
		stage.setObject(4, 3, new PFlower(false));
		stage.setObject(5, 3, new Wall(10));
		stage.setObject(7, 3, new Wall(7));
		stage.setObject(8, 3, new Mushroom(false));
		stage.setObject(9, 3, new Flower(false));
		stage.setObject(10, 3, new AppleRotten());
		stage.setObject(11, 3, new Wall(7));
		stage.setObject(13, 3, new Wall(10));
		stage.setObject(14, 3, new Wall(10));
		stage.setObject(15, 3, new Wall(10));
		stage.setObject(16, 3, new Wall(10));

		//Row 4
		stage.setObject(0, 4, new Wall(10));
		stage.setObject(3, 4, new Egg());
		stage.setObject(4, 4, new AppleRotten());
		stage.setObject(5, 4, new Wall(10));
		stage.setObject(6, 4, new Flower(false));
		stage.setObject(7, 4, new Wall(7));
		stage.setObject(8, 4, new Treasure());
		stage.setObject(9, 4, new AppleRotten());
		stage.setObject(11, 4, new Wall(7));
		...
		//Row 5
		stage.setObject(0, 5, new Wall(10));
		stage.setObject(2, 5, new Flower(false));
		stage.setObject(3, 5, new Flower(false));
		stage.setObject(5, 5, new Wall(10));
		stage.setObject(7, 5, new Wall(7));
		stage.setObject(8, 5, new Wall(7));
		stage.setObject(10, 5, new Flower(false));
		stage.setObject(11, 5, new Wall(7));
		stage.setObject(12, 5, new Wall(10));
		stage.setObject(13, 5, new Treasure());
		stage.setObject(14, 5, new Treasure());
		stage.setObject(15, 5, new Wall(10));
		stage.setObject(16, 5, new Wall(10));

		//Row 6
		stage.setObject(0, 6, new Wall(10));
		stage.setObject(1, 6, new Flower(false));
		stage.setObject(3, 6, new Flower(false));
		stage.setObject(4, 6, new Flower(false));
		...
		stage.setObject(12, 6, new Wall(10));
		stage.setObject(13, 6, new Wall(10));
		stage.setObject(14, 6, new Wall(10));
		stage.setObject(15, 6, new Wall(10));
		stage.setObject(16, 6, new Wall(10));

		//Row 7
		stage.setObject(0, 7, new Wall(10));
		stage.setObject(1, 7, new Wall(10));
		stage.setObject(2, 7, new Wall(10));
		stage.setObject(3, 7, new Flower(false));
		...
		stage.setObject(12, 7, new Flower(false));
		stage.setObject(14, 7, new Flower(false));
		stage.setObject(16, 7, new Wall(10));

		//Row 8
		stage.setObject(0, 8, new Wall(10));
		stage.setObject(1, 8, new Flower(false));
		stage.setObject(3, 8, new Crystal());
		stage.setObject(4, 8, new Flower(false));
		stage.setObject(5, 8, new Wall(10));
		stage.setObject(6, 8, new Crystal());
		stage.setObject(8, 8, new Flower(false));
		stage.setObject(15, 8, new Flower(false));
		stage.setObject(16, 8, new Wall(10));

		//Row 9
		stage.setObject(0, 9, new Wall(10));
		stage.setObject(1, 9, new Flower(false));
		stage.setObject(2, 9, new Treasure());
		...
		stage.setObject(16, 9, new Wall(10));

		//Row 10
		stage.setObject(0, 10, new Wall(10));
		stage.setObject(2, 10, new Flower(false));
		stage.setObject(3, 10, new Crystal());
		stage.demon.push(new Demon(stage, 4, 10, DIR_EAST));
		stage.setObject(5, 10, new Wall(10));
		stage.setObject(6, 10, new Crystal());
		stage.setObject(8, 10, new Flower(false));
		stage.setObject(10, 10, new Flower(false));
		stage.setObject(12, 10, new AppleRotten());
		...
		stage.setObject(15, 10, new Treasure());
		stage.setObject(16, 10, new Wall(10));

		//Row 11
		stage.setObject(0, 11, new Wall(10));
		stage.setObject(1, 11, new Wall(10));
		stage.setObject(2, 11, new Wall(10));
		stage.setObject(3, 11, new Wall(10));
		stage.setObject(4, 11, new Wall(10));
		stage.setObject(5, 11, new Wall(10));
		stage.setObject(6, 11, new LaserGun());
		stage.setObject(7, 11, new Wall(10));
		stage.setObject(8, 11, new Wall(10));
		stage.setObject(9, 11, new Wall(10));
		stage.setObject(10, 11, new Wall(10));
		stage.setObject(11, 11, new Wall(10));
		stage.setObject(12, 11, new Wall(10));
		stage.setObject(13, 11, new Wall(10));
		stage.setObject(14, 11, new Wall(10));
		stage.setObject(15, 11, new Wall(10));
		stage.setObject(16, 11, new Wall(10));
