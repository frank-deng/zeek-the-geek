levelData = [
	...
	new Stage(function(stage){
		...
		stage.setObject(8, 2, new Treasure());
		stage.setObject(9, 2, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.setObject(11, 4, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.setObject(11, 7, new Mushroom(false));
		stage.setObject(12, 7, new Flower(false));
		...
		stage.setObject(1, 10, new Flower(false));
		stage.demon.push(new Demon(stage, 2, 10, DIR_EAST));
	...
	new Stage(function(stage){
		...
		stage.setObject(1, 8, new Wall(8));
		...
		stage.setObject(9, 10, new Flower(false));
		stage.setObject(11, 10, new Flower(false));
		stage.setObject(12, 10, new Wall(8));
	...
	new Stage(function(stage){
		...
		stage.setObject(11, 8, new Mushroom(true));
		stage.setObject(12, 8, new Flower(false));
		stage.setObject(13, 8, new Flower(true));
		...
		stage.setObject(12, 9, new Mushroom(true));
	...
	new Stage(function(stage){
		...
		stage.setObject(11, 1, new Flower(false));
		stage.player.push(new Player(stage, 13, 1));
	...
	new Stage(function(stage){
		...
		stage.setObject(0, 1, new Wall(5));
		stage.setObject(1, 1, new Treasure());
		stage.setObject(2, 1, new Wall(5));
		stage.setObject(5, 1, new Flower(false));
		stage.setObject(6, 1, new Flower(false));
		stage.setObject(7, 1, new Flower(false));
		stage.setObject(8, 1, new Flower(false));
	...
	new Stage(function(stage){
		...
		stage.setObject(2, 4, new Flower(false));
		stage.setObject(3, 4, new Wall(8));
		stage.setObject(4, 4, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.setObject(3, 2, new Flower(true));
		stage.setObject(4, 2, new AppleRotten());
		stage.setObject(5, 2, new Flower(true));
	...
	new Stage(function(stage){
		...
		stage.demon.push(new Demon(stage, 12, 4, DIR_EAST));
		stage.setObject(15, 4, new PFlower(true));
		stage.setObject(16, 4, new Wall(4));
	...
	new Stage(function(stage){
		...
		stage.setObject(2, 10, new Wall(9));
		stage.setObject(3, 10, new Flower(false));
		stage.setObject(4, 10, new Flower(false));
		stage.setObject(5, 10, new Flower(false));
		stage.setObject(6, 10, new Flower(false));
	...
	new Stage(function(stage){
		...
		stage.setObject(9, 3, new Wall(6));
		stage.setObject(10, 3, new Wall(6));
		stage.player.push(new Player(stage, 11, 3));
		...
		stage.setObject(8, 7, new Flower(true));
		stage.setObject(9, 7, new Wall(6));
		stage.setObject(10, 7, new Mushroom(false));
		stage.setObject(15, 7, new Flower(false));
		stage.setObject(16, 7, new Wall(6));
	...
	new Stage(function(stage){
		...
		stage.setObject(10, 1, new Wall(8));
	...
	new Stage(function(stage){
		...
		//Row 7
		stage.setObject(0, 7, new Wall(5));
		stage.demon.push(new Demon(stage, 1, 7, DIR_EAST));
		...
		stage.setObject(9, 10, new Key());
		stage.setObject(10, 10, new Mushroom(true));
		stage.setObject(16, 10, new Wall(5));
	...
	new Stage(function(stage){
		...
		//Row 9
		stage.setObject(0, 9, new Wall(6));
		stage.setObject(4, 9, new LaserGun());
		stage.setObject(5, 9, new Key());
	...
	new Stage(function(stage){
		...
		stage.setObject(7, 6, new Flower(false));
		stage.setObject(8, 6, new Flower(false));
		stage.player.push(new Player(stage, 10, 6));
		stage.setObject(12, 6, new Flower(false));
		stage.setObject(13, 6, new Wall(8));
		stage.setObject(16, 6, new Wall(8));
	...
	new Stage(function(stage){
		...
		stage.setObject(3, 0, new Wall(2));
		stage.setObject(7, 0, new Wall(2));
		stage.setObject(8, 0, new Mushroom(false));
		...
		//Row 2
		stage.setObject(1, 2, new AppleRotten());
		...
		stage.setObject(10, 5, new Bomb());
		stage.setObject(14, 5, new Flower(false));
		stage.setObject(15, 5, new Wall(2));
		stage.setObject(16, 5, new Egg());
		...
		stage.setObject(13, 10, new Wall(2));
		stage.setObject(15, 10, new Wall(2));
		stage.setObject(16, 10, new Wall(2));
	...
	new Stage(function(stage){
		...
		stage.setObject(7, 4, new Treasure());
		...
		stage.setObject(4, 8, new Mushroom(false));
		stage.setObject(5, 8, new Flower(true));
		stage.setObject(6, 8, new Flower(true));
		stage.setObject(7, 8, new Flower(true));
		stage.setObject(8, 8, new Flower(false));
	...
	new Stage(function(stage){
		...
		stage.setObject(7, 1, new Mushroom(false));
		...
		//Row 10
		stage.setObject(0, 10, new LaserGun());
	...
	new Stage(function(stage){
		...
		stage.setObject(4, 2, new Wall(2));
		...
		stage.player.push(new Player(stage, 9, 4));
		stage.setObject(16, 4, new Wall(1));
		...
		stage.setObject(4, 8, new Treasure());
		stage.setObject(6, 8, new Mushroom(false));
		stage.setObject(7, 8, new Wall(2));
		stage.setObject(9, 8, new Flower(false));
		stage.setObject(10, 8, new Wall(0));
		stage.demon.push(new Demon(stage, 11, 8, DIR_EAST));
	...
	new Stage(function(stage){
		...
		stage.setObject(12, 1, new Mushroom(false));
	...
	new Stage(function(stage){
		//Row 0
		stage.setObject(0, 0, new Door());
		stage.setObject(1, 0, new Door());
		stage.setObject(2, 0, new Door());
		stage.setObject(3, 0, new Door());
		stage.setObject(4, 0, new Door());
		stage.setObject(5, 0, new Door());
		stage.setObject(6, 0, new Door());
		stage.setObject(7, 0, new Door());
		stage.setObject(8, 0, new Door());
		stage.setObject(9, 0, new Door());
		stage.setObject(10, 0, new Door());
		stage.setObject(11, 0, new Door());
		stage.setObject(12, 0, new Door());
		stage.setObject(13, 0, new Door());
		stage.setObject(14, 0, new Door());
		stage.setObject(15, 0, new Door());
		stage.setObject(16, 0, new Door());

		//Row 1
		stage.setObject(0, 1, new Door());
		stage.demon.push(new Demon(stage, 4, 1, DIR_WEST));
		stage.setObject(5, 1, new Door());
		stage.setObject(7, 1, new Door());
		stage.setObject(15, 1, new Door());
		stage.setObject(16, 1, new Door());

		//Row 2
		stage.setObject(0, 2, new Door());
		stage.setObject(2, 2, new Treasure());
		stage.setObject(3, 2, new Treasure());
		...
		//Row 3
		stage.setObject(0, 3, new Door());
		stage.setObject(5, 3, new Door());
		stage.setObject(9, 3, new Door());
		stage.setObject(15, 3, new Door());
		stage.setObject(16, 3, new Door());

		//Row 4
		stage.setObject(0, 4, new Door());
		stage.setObject(1, 4, new Door());
		stage.setObject(2, 4, new Door());
		stage.setObject(3, 4, new Door());
		stage.setObject(4, 4, new Door());
		...
		stage.setObject(16, 4, new Door());

		//Row 5
		stage.setObject(0, 5, new Door());
		...
		stage.setObject(16, 5, new Door());

		//Row 6
		stage.setObject(0, 6, new Door());
		...
		stage.setObject(14, 6, new Flower(false));
		stage.setObject(15, 6, new Flower(false));
		stage.setObject(16, 6, new Door());

		//Row 7
		stage.setObject(0, 7, new Door());
		...
		stage.setObject(13, 7, new Flower(true));
		stage.setObject(14, 7, new Flower(false));
		stage.player.push(new Player(stage, 15, 7));
		stage.setObject(16, 7, new Door());

		//Row 8
		stage.setObject(0, 8, new Door());
		stage.setObject(10, 8, new Door());
		stage.setObject(11, 8, new Flower(true));
		stage.setObject(12, 8, new Mushroom(false));
		stage.setObject(13, 8, new Flower(true));
		stage.setObject(14, 8, new Flower(false));
		stage.setObject(15, 8, new Flower(false));
		stage.setObject(16, 8, new Door());

		//Row 9
		stage.setObject(0, 9, new Door());
		...
		stage.setObject(16, 9, new Door());

		//Row 10
		stage.setObject(0, 10, new Door());
		...
		stage.setObject(14, 10, new Flower(false));
		stage.setObject(15, 10, new Flower(false));
		stage.setObject(16, 10, new Door());

		//Row 11
		stage.setObject(0, 11, new Door());
		stage.setObject(1, 11, new Door());
		stage.setObject(2, 11, new Door());
		stage.setObject(3, 11, new Door());
		stage.setObject(4, 11, new Door());
		stage.setObject(5, 11, new Door());
		stage.setObject(6, 11, new Door());
		stage.setObject(7, 11, new Door());
		stage.setObject(8, 11, new Door());
		stage.setObject(9, 11, new Door());
		stage.setObject(10, 11, new Door());
		stage.setObject(11, 11, new Door());
		stage.setObject(12, 11, new Door());
		stage.setObject(13, 11, new Door());
		stage.setObject(14, 11, new Door());
		stage.setObject(15, 11, new Door());
		stage.setObject(16, 11, new Door());
	...
	new Stage(function(stage){
		...
		stage.setObject(6, 5, new Flower(false));
		stage.setObject(8, 5, new Flower(true));
		stage.player.push(new Player(stage, 9, 5));
	...
	new Stage(function(stage){
		...
		stage.setObject(0, 9, new Wall(3));
		stage.setObject(4, 9, new Wall(3));
		stage.player.push(new Player(stage, 5, 9));
	...
	new Stage(function(stage){
		...
		stage.setObject(9, 0, new Wall(5));
		stage.setObject(10, 0, new Wall(5));
		stage.setObject(11, 0, new LaserGun());
		stage.setObject(12, 0, new Wall(5));
		stage.setObject(13, 0, new Wall(5));
		stage.setObject(14, 0, new Wall(5));
		stage.setObject(15, 0, new Wall(5));
	...
	new Stage(function(stage){
		...
		stage.setObject(9, 11, new Wall(1));
		stage.setObject(10, 11, new Wall(1));
		stage.setObject(11, 11, new Key());
		stage.setObject(12, 11, new Key());
		stage.setObject(13, 11, new Wall(0));
		stage.setObject(14, 11, new Wall(0));
		stage.setObject(15, 11, new Wall(0));
		stage.setObject(16, 11, new Wall(0));
