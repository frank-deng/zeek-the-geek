levelData = [
	...
	new Stage(function(stage){
		...
		stage.setObject(6, 6, new Wall(9));
	...
	new Stage(function(stage){
		...
		stage.setObject(11, 4, new LaserGun());
		...
		stage.setObject(6, 7, new Wall(10));
	...
	new Stage(function(stage){
		...
		stage.setObject(14, 2, new Wall(10));
		stage.setObject(15, 2, new Wall(10));
		...
		stage.setObject(13, 3, new Crystal());
		stage.setObject(14, 3, new Flower(true));
		stage.setObject(15, 3, new Crystal());
		stage.setObject(16, 3, new Flower(true));

		//Row 4
		stage.setObject(0, 4, new Crystal());
		...
		stage.setObject(16, 4, new Crystal());
		...
		stage.setObject(16, 5, new Flower(true));

		//Row 6
		stage.setObject(0, 6, new Crystal());
		stage.setObject(12, 6, new Crystal());
		stage.setObject(13, 6, new Egg());
		stage.setObject(14, 6, new Crystal());
		stage.setObject(16, 6, new Crystal());
		...
		stage.setObject(16, 7, new Flower(true));

		//Row 8
		stage.setObject(0, 8, new Crystal());
		stage.setObject(3, 8, new Crystal());
		stage.setObject(4, 8, new Egg());
		stage.setObject(5, 8, new Crystal());
		stage.setObject(8, 8, new Crystal());
		stage.player.push(new Player(stage, 9, 8));
		stage.setObject(10, 8, new Crystal());
		stage.setObject(16, 8, new Crystal());

		//Row 9
		stage.setObject(0, 9, new Flower(true));
		...
		stage.setObject(16, 10, new Crystal());

		//Row 11
		stage.setObject(0, 11, new Flower(true));
		stage.setObject(1, 11, new Crystal());
		stage.setObject(2, 11, new Flower(true));
		stage.setObject(3, 11, new Crystal());
		stage.setObject(4, 11, new Flower(true));
		stage.setObject(5, 11, new Crystal());
		stage.setObject(6, 11, new Flower(true));
		stage.setObject(7, 11, new Crystal());
		stage.setObject(8, 11, new Flower(true));
		stage.setObject(9, 11, new Crystal());
		stage.setObject(10, 11, new Flower(true));
		stage.setObject(11, 11, new Crystal());
		stage.setObject(12, 11, new Flower(false));
		stage.setObject(13, 11, new Flower(true));
		stage.setObject(14, 11, new Flower(false));
		stage.setObject(15, 11, new Key());
		stage.setObject(16, 11, new Flower(true));
	...
	new Stage(function(stage){
		...
		stage.setObject(8, 5, new AppleRotten());
		...
		stage.setObject(3, 8, new Wall(8));
		...
		stage.demon.push(new Demon(stage, 9, 9, DIR_WEST));
		stage.setObject(10, 9, new Ball());
		...
		stage.setObject(10, 10, new Ball());
	...
	new Stage(function(stage){
		...
		stage.setObject(10, 9, new Mushroom(true));
		...
		stage.setObject(10, 10, new Key());
		stage.setObject(11, 10, new Mushroom(true));
		stage.setObject(12, 10, new Flower(false));
	...
	new Stage(function(stage){
		...
		stage.setObject(8, 3, new AppleRotten());
	...
	new Stage(function(stage){
		...
		stage.setObject(14, 0, new Wall(10));
		stage.setObject(15, 0, new LaserGun());
		stage.setObject(16, 0, new PFlower(true));
		...
		stage.player.push(new Player(stage, 12, 3));
		...
		stage.setObject(3, 8, new LaserGun());
	...
	new Stage(function(stage){
		...
		stage.setObject(2, 1, new Wall(7));
		...
		stage.player.push(new Player(stage, 7, 2));
		...
		stage.setObject(11, 10, new Bomb());
	...
	new Stage(function(stage){
		...
		stage.setObject(2, 7, new Flower(false));
		stage.setObject(3, 7, new Flower(false));
		stage.setObject(5, 7, new Wall(10));
		stage.setObject(6, 7, new Wall(10));
	...
	new Stage(function(stage){
		...
		stage.setObject(10, 1, new Wall(10));
		...
		stage.setObject(12, 4, new Mushroom(true));
		stage.setObject(13, 4, new Mushroom(true));
		stage.setObject(14, 4, new Mushroom(false));
		stage.setObject(15, 4, new Flower(false));
		stage.setObject(16, 4, new Wall(4));
		...
		stage.setObject(5, 6, new Bomb());
		stage.demon.push(new Demon(stage, 6, 6, DIR_NORTH));
	...
	new Stage(function(stage){
		...
		stage.setObject(8, 3, new PFlower(true));
		stage.setObject(9, 3, new Egg());
		...
		stage.setObject(1, 9, new Mushroom(false));
	...
	new Stage(function(stage){
		...
		stage.setObject(3, 1, new Wall(9));
		...
		//Row 5
		stage.setObject(0, 5, new Mushroom(true));
		stage.setObject(1, 5, new Flower(true));
		...
		//Row 8
		stage.setObject(0, 8, new Flower(true));
		stage.setObject(1, 8, new PFlower(true));
		stage.setObject(2, 8, new Flower(true));
		...
		stage.setObject(7, 8, new Wall(9));
		stage.setObject(8, 8, new Flower(true));
		...
		stage.setObject(7, 9, new Wall(9));
		stage.setObject(8, 9, new Flower(true));
		...
		stage.setObject(13, 9, new Flower(true));
		stage.setObject(14, 9, new Flower(true));
		stage.setObject(16, 9, new PFlower(true));

		//Row 10
		stage.setObject(0, 10, new Key());
		...
		stage.setObject(7, 10, new Wall(9));
		...
		stage.setObject(13, 10, new Flower(true));
		stage.setObject(14, 10, new Flower(true));
		stage.setObject(15, 10, new Wall(9));
		stage.setObject(16, 10, new Wall(9));

		//Row 11
		stage.setObject(0, 11, new Pill());
		stage.setObject(1, 11, new PFlower(true));
		stage.setObject(2, 11, new Flower(true));
		stage.setObject(3, 11, new Flower(true));
		stage.setObject(4, 11, new Flower(true));
		stage.setObject(5, 11, new Flower(true));
		stage.setObject(6, 11, new Flower(true));
		stage.setObject(7, 11, new Wall(9));
		stage.setObject(8, 11, new Key());
		stage.demon.push(new Demon(stage, 9, 11, DIR_EAST));
		stage.setObject(11, 11, new Flower(true));
		stage.setObject(13, 11, new Flower(true));
		stage.setObject(15, 11, new Flower(true));
		stage.setObject(16, 11, new Key());
	...
	new Stage(function(stage){
		...
		stage.setObject(2, 2, new LaserGun());
		stage.setObject(4, 2, new LaserGun());
		stage.setObject(6, 2, new LaserGun());
		stage.setObject(8, 2, new LaserGun());
		...
		stage.setObject(13, 11, new Wall(6));
		stage.setObject(14, 11, new Wall(6));
		stage.setObject(15, 11, new PFlower(false));
		stage.setObject(16, 11, new Wall(6));
	...
	new Stage(function(stage){
		...
		//Row 1
		stage.setObject(0, 1, new Wall(1));
		stage.setObject(1, 1, new Ball());
		stage.setObject(3, 1, new Ball());
		stage.setObject(5, 1, new Ball());
		...
		//Row 4
		stage.setObject(0, 4, new Wall(1));
		stage.setObject(1, 4, new Wall(1));
		stage.setObject(2, 4, new Wall(1));
		stage.setObject(3, 4, new Wall(1));
		...
		//Row 9
		stage.setObject(0, 9, new Wall(1));
		stage.setObject(1, 9, new Wall(1));
		stage.setObject(2, 9, new Flower(true));
		stage.setObject(3, 9, new Wall(1));
		stage.setObject(4, 9, new Crystal());
		stage.setObject(5, 9, new Flower(false));
		stage.setObject(7, 9, new Flower(false));
	...
	new Stage(function(stage){
		...
		stage.setObject(14, 0, new LaserGun());
		stage.setObject(15, 0, new LaserGun());
		stage.setObject(16, 0, new LaserGun());

		//Row 1
		stage.setObject(0, 1, new Wall(3));
		stage.setObject(4, 1, new Pill());
		...
		stage.setObject(14, 1, new PFlower(true));
		stage.setObject(15, 1, new PFlower(true));
		stage.setObject(16, 1, new PFlower(true));
		...
		stage.setObject(2, 3, new Treasure());
		...
		stage.setObject(1, 6, new Flower(true));
		stage.setObject(2, 6, new Flower(true));
		stage.setObject(4, 6, new Door());
		stage.setObject(5, 6, new Flower(true));
		stage.player.push(new Player(stage, 6, 6));
		...
		stage.demon.push(new Demon(stage, 8, 10, DIR_EAST));
	...
	new Stage(function(stage){
		...
		stage.setObject(4, 1, new Wall(8));
		stage.setObject(7, 1, new Flower(false));
		stage.setObject(9, 1, new Wall(8));
		...
		stage.setObject(1, 3, new Flower(false));
		stage.player.push(new Player(stage, 2, 3));
		stage.setObject(4, 3, new Wall(8));
		...
		stage.setObject(15, 6, new Apple());
		...
		stage.setObject(6, 9, new Flower(true));
		stage.setObject(7, 9, new AppleRotten());
		stage.setObject(8, 9, new Flower(true));
		stage.setObject(9, 9, new Wall(8));
		stage.setObject(10, 9, new Pill());
		...
		stage.setObject(5, 10, new Wall(8));
		stage.setObject(7, 10, new Flower(true));
		stage.setObject(9, 10, new Wall(8));
	...
	new Stage(function(stage){
		...
		stage.demon.push(new Demon(stage, 13, 1, DIR_SOUTH));
		stage.setObject(14, 1, new PFlower(true));
		stage.setObject(15, 1, new PFlower(true));
		stage.setObject(16, 1, new Wall(7));
		...
		//Row 5
		stage.setObject(0, 5, new Wall(7));
		stage.setObject(1, 5, new Bomb());
		stage.setObject(2, 5, new Flower(false));
		stage.setObject(4, 5, new Door());
		stage.setObject(6, 5, new Flower(false));
		...
		stage.setObject(10, 6, new Pill());
		stage.setObject(11, 6, new Flower(true));
		stage.setObject(16, 6, new Wall(7));

		//Row 7
		stage.setObject(0, 7, new Wall(7));
		stage.setObject(1, 7, new Pill());
		stage.setObject(3, 7, new PFlower(true));
		stage.setObject(4, 7, new Wall(7));
		stage.setObject(5, 7, new Wall(7));
	...
	new Stage(function(stage){
		//Row 0
		stage.setObject(2, 0, new PFlower(true));
		...
		stage.setObject(15, 0, new PFlower(true));
		stage.setObject(16, 0, new PFlower(true));
		...
		stage.setObject(13, 3, new Flower(true));
		stage.setObject(14, 3, new Flower(true));
		stage.setObject(15, 3, new Flower(true));
		stage.setObject(16, 3, new Key());
		...
		stage.setObject(16, 5, new Mushroom(false));

		//Row 6
		stage.demon.push(new Demon(stage, 2, 6, DIR_NORTH));
		stage.setObject(3, 6, new Wall(5));
		stage.setObject(7, 6, new Wall(5));
		stage.setObject(14, 6, new Flower(false));
		stage.setObject(15, 6, new Wall(5));
		stage.setObject(16, 6, new Flower(true));
		...
		//Row 9
		stage.setObject(0, 9, new Treasure());
		stage.setObject(2, 9, new Flower(false));
		...
		//Row 10
		stage.setObject(0, 10, new Treasure());
		stage.setObject(1, 10, new Flower(false));
		stage.setObject(2, 10, new PFlower(true));
		...
		stage.setObject(13, 10, new Apple());
		stage.setObject(15, 10, new PFlower(true));
		stage.setObject(16, 10, new Egg());

		//Row 11
		stage.setObject(0, 11, new Treasure());
		stage.setObject(1, 11, new Flower(false));
		stage.setObject(3, 11, new Wall(5));
		stage.setObject(6, 11, new Pill());
		stage.setObject(7, 11, new Wall(5));
		stage.setObject(8, 11, new Egg());
	...
	new Stage(function(stage){
		...
		stage.setObject(7, 1, new Crystal());
		stage.setObject(9, 1, new AppleRotten());
		...
		stage.setObject(8, 7, new PFlower(true));
		stage.setObject(9, 7, new Crystal());
		stage.setObject(10, 7, new Bomb());
		stage.setObject(11, 7, new Flower(false));
		stage.setObject(12, 7, new Wall(2));
		stage.demon.push(new Demon(stage, 13, 7, DIR_EAST));
		stage.setObject(16, 7, new Wall(2));
		...
		stage.setObject(2, 9, new Flower(true));
		stage.setObject(3, 9, new Flower(true));
		stage.setObject(4, 9, new Wall(2));
		stage.setObject(5, 9, new Flower(false));
	...
	new Stage(function(stage){
		...
		//Row 2
		stage.setObject(0, 2, new Wall(0));
		stage.setObject(1, 2, new Wall(0));
		...
		stage.setObject(5, 3, new Flower(true));
		stage.setObject(6, 3, new AppleRotten());
		stage.setObject(7, 3, new PFlower(false));
		...
		stage.player.push(new Player(stage, 4, 6));
		stage.setObject(5, 6, new Flower(false));
		stage.setObject(7, 6, new Flower(false));
		stage.setObject(8, 6, new Flower(false));
	...
	new Stage(function(stage){
		...
		stage.setObject(2, 7, new Wall(8));
		stage.setObject(3, 7, new Wall(8));
		...
		stage.setObject(9, 10, new Crystal());
		stage.demon.push(new Demon(stage, 10, 10, DIR_WEST));
	...
	new Stage(function(stage){
		...
		stage.demon.push(new Demon(stage, 5, 1, DIR_SOUTH));
		stage.setObject(6, 1, new Wall(0));
		stage.setObject(7, 1, new Egg());
		...
		stage.setObject(0, 9, new Wall(1));
		stage.setObject(1, 9, new PFlower(true));
		stage.setObject(2, 9, new Treasure());
	...
	new Stage(function(stage){
		...
		stage.setObject(10, 10, new Wall(1));
		stage.demon.push(new Demon(stage, 11, 10, DIR_EAST));
		stage.setObject(13, 10, new Flower(false));
		stage.setObject(14, 10, new Flower(false));
		stage.setObject(15, 10, new Flower(false));
		stage.setObject(16, 10, new Wall(1));
	...
	new Stage(function(stage){
		...
		stage.setObject(11, 4, new Wall(9));
		stage.setObject(12, 4, new Flower(false));
		stage.setObject(13, 4, new Flower(true));
		stage.setObject(14, 4, new Flower(false));
		...
		stage.setObject(3, 9, new Apple());
		stage.setObject(5, 9, new Flower(false));
		stage.player.push(new Player(stage, 6, 9));
		stage.setObject(7, 9, new Flower(true));
		stage.setObject(8, 9, new Crystal());
	...
	new Stage(function(stage){
		...
		stage.setObject(7, 7, new Crystal());
		stage.setObject(8, 7, new Flower(true));
		stage.setObject(9, 7, new Crystal());
		...
		stage.setObject(3, 10, new PFlower(true));
		stage.setObject(5, 10, new Flower(false));
		stage.setObject(6, 10, new Wall(5));
		stage.demon.push(new Demon(stage, 7, 10, DIR_EAST));
	...
	new Stage(function(stage){
		...
		stage.setObject(4, 1, new Flower(false));
		stage.setObject(5, 1, new Flower(false));
		stage.player.push(new Player(stage, 6, 1));
		...
		stage.demon.push(new Demon(stage, 9, 2, DIR_WEST));
		...
		stage.setObject(14, 4, new Flower(true));
		stage.setObject(15, 4, new Apple());
		stage.setObject(16, 4, new Wall(7));
		...
		stage.setObject(3, 6, new Wall(7));
		stage.setObject(5, 6, new Egg());
		...
		stage.setObject(9, 8, new Mushroom(false));
		...
		stage.setObject(6, 10, new Wall(7));
	...
	new Stage(function(stage){
		//Row 0
		stage.setObject(0, 0, new Wall(11));
		stage.setObject(1, 0, new Wall(11));
		stage.setObject(2, 0, new Wall(11));
		stage.setObject(3, 0, new Wall(11));
		stage.setObject(4, 0, new Wall(11));
		stage.setObject(5, 0, new Wall(11));
		stage.setObject(6, 0, new Wall(11));
		stage.setObject(7, 0, new Wall(11));
		stage.setObject(8, 0, new Wall(11));
		stage.setObject(9, 0, new Wall(11));
		stage.setObject(10, 0, new Wall(11));
		stage.setObject(11, 0, new Wall(11));
		stage.setObject(12, 0, new Wall(11));
		stage.setObject(13, 0, new Wall(11));
		stage.setObject(14, 0, new Wall(11));
		stage.setObject(15, 0, new Wall(11));
		stage.setObject(16, 0, new Wall(11));

		//Row 1
		stage.setObject(0, 1, new Wall(11));
		stage.setObject(1, 1, new Apple());
		stage.setObject(2, 1, new Flower(true));
		stage.setObject(4, 1, new Flower(true));
		stage.setObject(5, 1, new Wall(11));
		stage.setObject(6, 1, new Flower(true));
		stage.setObject(8, 1, new Flower(false));
		stage.setObject(10, 1, new Flower(true));
		stage.setObject(11, 1, new Door());
		stage.setObject(12, 1, new Flower(true));
		stage.setObject(13, 1, new Crystal());
		stage.setObject(15, 1, new Crystal());
		stage.setObject(16, 1, new Wall(11));

		//Row 2
		stage.setObject(0, 2, new Wall(11));
		stage.setObject(3, 2, new Apple());
		stage.setObject(4, 2, new Key());
		stage.setObject(5, 2, new PFlower(false));
		stage.setObject(7, 2, new Apple());
		stage.setObject(10, 2, new Flower(false));
		stage.setObject(11, 2, new Wall(11));
		stage.setObject(12, 2, new Wall(11));
		stage.setObject(13, 2, new Wall(11));
		stage.setObject(14, 2, new Crystal());
		stage.setObject(15, 2, new Mushroom(false));
		stage.setObject(16, 2, new Wall(11));

		//Row 3
		stage.setObject(0, 3, new Wall(11));
		stage.setObject(1, 3, new Flower(false));
		stage.setObject(2, 3, new Wall(11));
		stage.setObject(3, 3, new Wall(11));
		stage.setObject(4, 3, new Wall(11));
		stage.setObject(5, 3, new Wall(11));
		stage.setObject(6, 3, new Treasure());
		stage.setObject(7, 3, new Wall(11));
		stage.setObject(8, 3, new Wall(11));
		stage.setObject(9, 3, new Wall(11));
		stage.setObject(11, 3, new PFlower(true));
		stage.setObject(12, 3, new Flower(false));
		stage.setObject(13, 3, new Wall(11));
		stage.setObject(14, 3, new Wall(11));
		stage.setObject(15, 3, new Wall(11));
		stage.setObject(16, 3, new Wall(11));

		//Row 4
		stage.setObject(0, 4, new Wall(11));
		stage.setObject(1, 4, new PFlower(false));
		stage.setObject(3, 4, new Flower(false));
		stage.setObject(5, 4, new Door());
		stage.setObject(6, 4, new Treasure());
		stage.demon.push(new Demon(stage, 7, 4, DIR_EAST));
		stage.setObject(8, 4, new LaserGun());
		stage.setObject(9, 4, new Wall(11));
		stage.setObject(10, 4, new Flower(false));
		stage.setObject(12, 4, new Flower(false));
		stage.setObject(13, 4, new Apple());
		stage.setObject(15, 4, new PFlower(true));
		stage.setObject(16, 4, new Wall(11));

		//Row 5
		stage.setObject(0, 5, new Wall(11));
		stage.setObject(2, 5, new Flower(false));
		stage.setObject(4, 5, new Crystal());
		stage.setObject(5, 5, new Wall(11));
		stage.setObject(6, 5, new Wall(11));
		stage.setObject(7, 5, new Wall(11));
		stage.setObject(8, 5, new Wall(11));
		stage.setObject(9, 5, new Wall(11));
		stage.setObject(10, 5, new Flower(true));
		stage.setObject(11, 5, new Flower(false));
		stage.setObject(14, 5, new Flower(false));
		stage.setObject(16, 5, new Wall(11));

		//Row 6
		stage.setObject(0, 6, new Wall(11));
		stage.setObject(2, 6, new Apple());
		stage.setObject(3, 6, new Flower(true));
		stage.setObject(5, 6, new Wall(11));
		stage.setObject(6, 6, new LaserGun());
		...
		stage.setObject(14, 6, new Apple());
		stage.setObject(16, 6, new Wall(11));

		//Row 7
		stage.setObject(0, 7, new Wall(11));
		stage.setObject(1, 7, new Flower(false));
		stage.setObject(3, 7, new Flower(true));
		stage.setObject(4, 7, new Flower(false));
		stage.setObject(5, 7, new Wall(11));
		stage.setObject(6, 7, new Wall(11));
		stage.setObject(7, 7, new PFlower(true));
		stage.setObject(8, 7, new Flower(false));
		stage.setObject(9, 7, new Wall(11));
		stage.setObject(10, 7, new Key());
		stage.setObject(11, 7, new Crystal());
		stage.player.push(new Player(stage, 13, 7));
		stage.setObject(14, 7, new Crystal());
		stage.setObject(15, 7, new Flower(false));
		stage.setObject(16, 7, new Wall(11));

		//Row 8
		stage.setObject(0, 8, new Wall(11));
		stage.setObject(1, 8, new Flower(true));
		stage.setObject(2, 8, new Flower(false));
		stage.setObject(3, 8, new Flower(true));
		stage.setObject(5, 8, new Flower(false));
		stage.setObject(6, 8, new Wall(11));
		stage.setObject(7, 8, new Wall(11));
		stage.setObject(8, 8, new Door());
		stage.setObject(9, 8, new Wall(11));
		stage.setObject(10, 8, new Wall(11));
		stage.setObject(11, 8, new Wall(11));
		stage.setObject(12, 8, new Apple());
		stage.setObject(13, 8, new Apple());
		stage.setObject(14, 8, new Apple());
		stage.setObject(16, 8, new Wall(11));

		//Row 9
		stage.setObject(0, 9, new Wall(11));
		stage.setObject(1, 9, new Crystal());
		stage.setObject(4, 9, new Flower(false));
		stage.setObject(6, 9, new Flower(false));
		...
		stage.setObject(13, 9, new Flower(false));
		stage.setObject(15, 9, new Flower(false));
		stage.setObject(16, 9, new Wall(11));

		//Row 10
		stage.setObject(0, 10, new Wall(11));
		stage.setObject(1, 10, new Key());
		stage.setObject(2, 10, new Crystal());
		stage.setObject(3, 10, new Flower(true));
		stage.setObject(5, 10, new Flower(true));
		stage.setObject(7, 10, new Wall(11));
		stage.setObject(8, 10, new Egg());
		stage.setObject(9, 10, new Wall(11));
		stage.setObject(10, 10, new Key());
		stage.setObject(11, 10, new Wall(11));
		stage.setObject(12, 10, new Flower(true));
		stage.setObject(14, 10, new Flower(true));
		stage.setObject(16, 10, new Wall(11));

		//Row 11
		stage.setObject(0, 11, new Wall(11));
		stage.setObject(1, 11, new Wall(11));
		stage.setObject(2, 11, new Wall(11));
		stage.setObject(3, 11, new Wall(11));
		stage.setObject(4, 11, new Wall(11));
		stage.setObject(5, 11, new Wall(11));
		stage.setObject(6, 11, new Wall(11));
		stage.setObject(7, 11, new Wall(11));
		stage.setObject(8, 11, new Wall(11));
		stage.setObject(9, 11, new Wall(11));
		stage.setObject(10, 11, new Wall(11));
		stage.setObject(11, 11, new Wall(11));
		stage.setObject(12, 11, new Wall(11));
		stage.setObject(13, 11, new Wall(11));
		stage.setObject(14, 11, new Wall(11));
		stage.setObject(15, 11, new Wall(11));
		stage.setObject(16, 11, new Wall(11));
	...
	new Stage(function(stage){
		...
		stage.demon.push(new Demon(stage, 7, 1, DIR_EAST));
		...
		stage.setObject(13, 1, new Flower(true));
		stage.setObject(14, 1, new Wall(10));
		...
		stage.setObject(12, 3, new Flower(false));
		stage.setObject(13, 3, new PFlower(true));
		stage.setObject(14, 3, new Wall(3));
		stage.setObject(15, 3, new Wall(3));
		stage.setObject(16, 3, new Wall(3));
		...
		//Row 6
		stage.setObject(0, 6, new Wall(3));
		stage.setObject(1, 6, new Wall(3));
		...
		stage.setObject(7, 6, new Wall(3));
		stage.setObject(8, 6, new Egg());
		stage.setObject(9, 6, new Wall(3));
		stage.setObject(10, 6, new Flower(false));
		stage.setObject(12, 6, new Apple());
		stage.setObject(15, 6, new Wall(3));
		stage.setObject(16, 6, new Wall(3));
		...
		stage.setObject(5, 9, new Crystal());
		stage.setObject(7, 9, new Wall(3));
		stage.demon.push(new Demon(stage, 8, 9, DIR_EAST));
	...
	new Stage(function(stage){
		...
		//Row 1
		stage.setObject(0, 1, new Crystal());
		stage.setObject(2, 1, new Crystal());
		stage.player.push(new Player(stage, 3, 1));
		stage.setObject(5, 1, new Wall(2));
		...
		stage.setObject(5, 4, new PFlower(false));
		stage.setObject(6, 4, new Flower(false));
		stage.setObject(9, 4, new Apple());
		stage.setObject(10, 4, new PFlower(false));
		stage.setObject(11, 4, new Flower(false));
		stage.setObject(12, 4, new Wall(2));
		stage.setObject(13, 4, new Ball());
		stage.setObject(14, 4, new Ball());
		stage.setObject(15, 4, new Ball());
		stage.setObject(16, 4, new Crystal());
		...
		//Row 6
		stage.setObject(1, 6, new Bomb());
		stage.setObject(4, 6, new PFlower(false));
		...
		//Row 8
		stage.setObject(0, 8, new PFlower(true));
		stage.setObject(4, 8, new Crystal());
		...
		stage.setObject(8, 11, new Wall(2));
		stage.setObject(9, 11, new Wall(2));
		stage.setObject(10, 11, new PFlower(true));
		stage.setObject(12, 11, new Wall(2));
		stage.setObject(13, 11, new Ball());
		stage.setObject(15, 11, new Crystal());
